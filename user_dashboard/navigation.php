...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #7D3C98; position: fixed; top: 0; left: 0; width: 100%; z-index: 1000;">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            <button class="btn btn-outline-light position-relative me-3" style="border-color: #F4D03F; color: #F4D03F;" onclick="showNotification()">
...
<script>
    function showNotification() {
        alert("This feature is under development. You will be able to receive notifications regarding order status soon.");
    }
</script>
